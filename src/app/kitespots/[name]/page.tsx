...
async function getSpotData(name: string) {
  ...
  return {
    ...
    description: `${spot.name} is a popular kitesurfing spot located in ${spot.location}, ${spot.country}. It offers ${spot.water_type?.toLowerCase() || "various"} water conditions and is suitable for ${spot.difficulty?.toLowerCase() || "different level"} riders.`,
